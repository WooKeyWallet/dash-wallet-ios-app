...
class SendViewHeader: UIView {
    ...
    internal func configureConstraints() {
        ...
        remainLabel.snp.makeConstraints { (make) in
            make.top.equalTo(remainTitleLab.snp.bottom).offset(10)
            make.right.equalTo(remainTitleLab)
        }
        priceLabel.snp.makeConstraints { (make) in
            make.top.equalTo(remainLabel.snp.bottom).offset(5)
    ...
    public func configureModels(model: (icon: UIImage?, walletName: String, amount: String, price: String)) {
