...
class TokenWalletViewCell: BaseTableViewCell {
    ...
    private lazy var priceLabel: UILabel = {
        let lab = UILabel()
        lab.textColor = AppTheme.Color.text_light
        lab.font = AppTheme.Font.text_small
    ...
    override func frameLayout() {
        ...
        detailLabel.updateFrame(CGRect(x: nameLabel.maxX, y: nameLabel.midY - detailLabel.font.lineHeight * 0.5, width: infoBG.width - 18 - nameLabel.maxX, height: detailLabel.font.lineHeight))
        priceLabel.updateFrame(CGRect(x: detailLabel.x, y: detailLabel.maxY + 2, width: detailLabel.width, height: priceLabel.font.lineHeight))
