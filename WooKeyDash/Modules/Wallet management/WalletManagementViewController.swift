...
class WalletManagementViewController: BaseViewController {
    ...
    private lazy var tokenListVC: TokenWalletsViewController = {
        TokenWalletsViewController(viewModel: viewModel)
    }()
    ...
    override func configureBinds() {
        ...
        WalletService.shared.refreshState.observe(self) { (_, strongSelf) in
            strongSelf.loadData()
        }
    }
    ...
    override func viewDidLayoutSubviews() {
        ...
        tokenListVC.view.frame = view.bounds
    }
    
    
    // MARK: - Methods (Private)
    
    private func toCreateWallet(style: WalletCreateStyle) {
    ...
    @objc private func recoveryBtnAction() {
        toCreateWallet(style: .recovery)
    }
    
    @objc private func createBtnAction() {
        toCreateWallet(style: .new)
    }
    
    // MARK: - Methods (Public)
    
    public func loadData() {
        tokenListVC.loadData()
    }
